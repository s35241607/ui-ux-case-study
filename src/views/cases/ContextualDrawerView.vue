      ...
      <template #right>
        <div class="relative h-full flex overflow-hidden">
          ...
          >
            ...
            <div class="p-4 border-t bg-card sticky bottom-0 flex gap-3">
              <Button variant="outline" class="flex-1" @click="goodSelectedTicket = null">關閉</Button>
              <Button class="flex-1">儲存紀錄</Button>
            </div>
          </div>
