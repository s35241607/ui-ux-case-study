    ...
    <SplitView>
      ...
      <template #left>
        <div class="flex-1 flex flex-col">
          <!-- Case 1 -->
          <CaseBlock index="1" title="刪除確認按鈕" description="危險操作無警示色，取消與確認順序顛倒" tag="ui">
            <Card>
              <CardHeader>
          ...
          <!-- Case 2 -->
          <CaseBlock index="2" title="方案升級選項" description="三個按鈕視覺重量完全相同，用戶不知道哪個是主要操作" tag="ui">
            <Card>
              <CardHeader>
      ...
      <template #right>
        <div class="flex-1 flex flex-col">
          <!-- Case 1 -->
          <CaseBlock index="1" title="刪除確認按鈕" description="Destructive 紅色警示 + Outline 取消，正確順序（取消在左）" tag="ui">
          ...
          <!-- Case 2 -->
          <CaseBlock index="2" title="方案升級選項" description="Primary > Secondary > Ghost，視覺重量清楚引導主要操作" tag="ui">
            <Card class="transition-all duration-200 hover:shadow-sm">
              <CardHeader>
                <CardTitle>升級方案</CardTitle>
                <CardDescription>獲取更多進階功能與儲存空間。</CardDescription>
